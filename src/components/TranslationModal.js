      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={onClose} onPressIn={() => hapticSelection()} style={styles.closeButton}>
          ...
          <View style={styles.ayahNavButtons}>
            <TouchableOpacity
              ...
              disabled={isFirstAyah}
                              onPress={() => { hapticSelection(); onAyahChange('prev'); }}
            ...
            <TouchableOpacity
              ...
              disabled={isLastAyah}
                              onPress={() => { hapticSelection(); onAyahChange('next'); }}
                onPressIn={() => hapticSelection()}
            >
          ...
          <View style={styles.sourceButtonsBottom}>
            {bottomOptions.map((key) => (
              <TouchableOpacity
                ...
                onPress={() => { hapticSelection(); handleSourceChange(key); }}
                onPressIn={() => hapticSelection()}
              >
