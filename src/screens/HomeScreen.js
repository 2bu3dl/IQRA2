        ...
        <View style={styles.header}>
          <View style={styles.logoContainer}>
            ...
            <View style={[styles.logoTextContainer, {
              ...
              <Image 
                source={language === 'ar' ? require('../assets/IQRA2iconArabic.png') : require('../assets/IQRA2icon.png')} 
                style={styles.logo} 
                resizeMode="contain" 
              />
            </View>
          ...
          <View style={styles.buttonGrid}>
            ...
            >
              <View style={styles.buttonIconContainer}>
                <Image source={require('../assets/openQuran.png')} style={[styles.buttonIcon, { width: language === 'ar' ? 45 : 35, height: language === 'ar' ? 45 : 35 }]} resizeMode="contain" />
              </View>
                <View style={{ 
